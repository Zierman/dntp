...
public abstract class Arg<T>
{
	 ...
	 * 
	 * @return the T object that was set or the default value if it was not set
	 *         explicitly of an argument
	 */
	public T getValue()
	{
		return value;
	 ...
	 * 
	 * @param flag
	 *            the string to check against the arugment's flag
	 ...
	 * 
	 * @param newValue
	 *            the T object to set the value to
	 */
	 ...
	 * @throws Exception
	 *             if any exception happens when processing the inline argument
	 */
