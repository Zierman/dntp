...
public class LogPrinter extends Printer
{
	 ...
	 * 
	 * @param printerIsOn
	 *            the starting state of this printer
	 * @param logPrintStream
	 *            the print stream that this printer will output to
	 * @param startTime
	 *            the time that the logged part of the program started started
	 */
	 ...
	 * 
	 * @param ackFrame
	 *            the AckFrame recieved
	 * @param expectedAckNumber
	 *            the int expected acknowledgement number
	 * @param sequenceNumber
	 *            the sequence number of the ack
	 * @param numberOfAckNumbers
	 *            the int number of possible ack numbers
	 */
	public void ackReceived(AckFrame ackFrame, int expectedAckNumber, int sequenceNumber, int numberOfAckNumbers)
	{
		if (printerIsOn)
		{
			try
			{
				...
				// that it was for the most recently received chunkFrame that
				// works with the ackNumber
				else
				{
	 ...
	 * 
	 * @param f
	 *            the ChunkFrame received
	 * @param expectedSequenceNumber
	 *            the int expected sequence number
	 */
	 ...
	 * 
	 * @param f
	 *            AckFrame resent to be logged
	 * @param chunkSequenceNumber
	 *            sequence number of the linked ChunkFrame
	 */
	 ...
	 * 
	 * @param f
	 *            ChunkFrame resent to be logged
	 * @param startOffset
	 ...
	 * 
	 * @param f
	 *            EndFrame resent to be logged
	 * @param digitLengthOfOffset
	 *            the length of the largest offset in digits
	 */
	 ...
	 * 
	 * @param f
	 *            the ChunkFrame that we timed out on the ack for
	 */
	 ...
	 * 
	 * @param f
	 *            Frame that we get the error string for
	 * @return "ERRR" if frame was corrupt, "DROP" if frame was dropped, or
	 *         "SENT" if no error
	 */
