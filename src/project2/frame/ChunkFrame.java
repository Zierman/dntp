...
public class ChunkFrame extends Frame
{
	 ...
	 * 
	 * @param c
	 *            the Chunk of data held in this frame as payload
	 * @param sequenceNumber
	 *            The int sequenceNumber of this ChunkFrame
	 */
	 ...
	 * 
	 * @param packet
	 *            the DatagramPacket to extract a ChunkFrame from
	 */
	public ChunkFrame(DatagramPacket packet)
	{
		...
		int i = 0;
		int j = 0;
		byte[] checkSumB = new byte[2], lenB = new byte[2], seqB = new byte[4], dataB;
