...
public class FileAssembler implements Loggable
{
	 ...
	 * 
	 * @param filename
	 *            the filename of the file to be assembled
	 */
	...
	/**
	 * @param filename
	 *            the filename of the desired output file
	 * @param chunks
	 *            an Iterable collection of chuncks to be assembled
